...
<div class="container">
	<p class="card">
		From early in the year until late spring we begin to cut, split, and stack as much of our wood as possible, so that it can dry out (season) enough to be fit for burning when winter returns. This seasoned wood sells out very quickly once the cool
	...
	<div class="grid">
		...
		<PricingCard title="Green Pine" price="$160" isCampfire={true}>
			<ul>
				<li>Green pine</li>
				<li>Dries very quickly</li>
				<li>Once dry, it's perfect for outdoor campfires or solo stoves</li>
			</ul>
		</PricingCard>
		<PricingCard title="Seasoned Pine" price="$200" isCampfire={true}>
			<ul>
				<li>Seasoned pine</li>
				<li>Ready to burn outdoors in a campfire</li>
			</ul>
		</PricingCard>
	</div>
</div>
